...
import {BiDislike, BiSmile, BsCart2, BsCloudy, BsCreditCard, BsPerson, GoMail} from "react-icons/all";
    ...
    <>
      <CRow>
        <div style={{
          ...
          <h2>Pricing built for businesses of all sizes <br/>
          </h2>
        </div>

        <span>Access a complete EDI translation & validation platform with simple, tier-based pricing, and the freedom to
            cancel at any time. No setup fees or hidden fees, always know what you'll pay.</span>
        <CRow style={{
          display: 'flex', alignItems: 'center', justifyContent: 'center',
        }}>
          <CCol>
            <CCard className="mb-4"
                   style={{display: "flex", alignItems: 'center', justifyContent: 'center', width: 250}}>
              &nbsp;&nbsp;
