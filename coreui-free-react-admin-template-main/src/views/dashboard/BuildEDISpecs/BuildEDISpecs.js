...
import {BsBoxArrowUpRight, IoIosAddCircle} from "react-icons/all";
      ...
      <CCard className="mb-4" style={{height: 500}}>
        <CCardHeader>
          ...
          <CButton component="How to import SEF files?" color="primary" href="#" role="button">
            SEF Import Guide <BsBoxArrowUpRight/>
          </CButton>
          <CButton component="How to modify EDI models using the OpenEDI format?" color="primary" href="#" role="button">
